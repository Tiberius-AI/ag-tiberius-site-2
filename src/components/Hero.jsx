...
import './Hero.css';
import WheelOfResults from './wheel-of-results';
            ...
            <div className="container hero-inner">
                <div className="hero-content">
                    ...
                    <div className="hero-buttons">
                        <a className="cta-button primary-cta hero-btn" href="https://form.jotform.com/251756446512156" target="_blank" rel="noopener noreferrer">
                        ...
                        <a className="cta-button secondary-cta hero-btn" href="https://form.jotform.com/251756446512156" target="_blank" rel="noopener noreferrer">
                            See How It Works
                        </a>
                    </div>
